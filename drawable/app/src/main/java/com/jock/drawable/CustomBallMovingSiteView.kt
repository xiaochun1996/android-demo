...
class CustomBallMovingSiteView(context: Context, attributeSet: AttributeSet?, defStyleAttr: Int) :
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        arrayOf(this.javaClass.declaredFields).filter { it.lastIndex==1}
    ...
    private val ballDrawable2 = BallDrawable()
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        ballDrawable2.setBounds(0, 0, minLength, minLength)
        ballDrawable2.draw(canvas)
    }
}
